              ...
              <div className="border-t border-gray-200 pt-4 pb-3">
                <div className="max-w-3xl mx-auto px-4 flex items-center sm:px-6">
                  <div className="flex-shrink-0">
                    <img className="h-10 w-10 rounded-full" src={testUser.imageUrl} alt="" />
                  </div>
                  <div className="ml-3">
                    <div className="text-base font-medium text-gray-800">{testUser.name}</div>
                    <div className="text-sm font-medium text-gray-500">{testUser.email}</div>
                  </div>
                  <button
                    type="button"
